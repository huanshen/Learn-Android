...
public class CustomImageView extends View
{
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            switch (attr)
            {
                case R.styleable.CustomImageView_titleText1:
                    ...
                    break;
                case R.styleable.CustomImageView_titleTextColor1:
                    // 默认颜色设置为黑色
                    mTitleTextColor = a.getColor(attr, Color.BLACK);
                    break;
                case R.styleable.CustomImageView_titleTextSize1:
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        mPaint.setColor(mTitleTextColor);
        Toast.makeText(getContext(),getWidth() + "  "+getMeasuredWidth(), Toast.LENGTH_SHORT).show();
