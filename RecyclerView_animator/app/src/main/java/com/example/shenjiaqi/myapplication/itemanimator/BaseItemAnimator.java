...
import com.example.shenjiaqi.myapplication.ViewHelper;
...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        // Next, move stuff
        if (movesPending) {
            final ArrayList<BaseItemAnimator.MoveInfo> moves = new ArrayList<>();
        ...
        if (changesPending) {
            final ArrayList<BaseItemAnimator.ChangeInfo> changes = new ArrayList<>();
            ...
            Runnable changer = new Runnable() {
                @Override
                public void run() {
                    for (BaseItemAnimator.ChangeInfo change : changes) {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).setListener(
                new DefaultRemoveVpaListener(holder)).start();
    }
    ...
    public boolean animateMove(final RecyclerView.ViewHolder holder, int fromX, int fromY,
        ...
        mPendingMoves.add(new BaseItemAnimator.MoveInfo(holder, fromX, fromY, toX, toY));
        return true;
    }
    ...
    public boolean animateChange(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder,
        ...
        mPendingChanges.add(new BaseItemAnimator.ChangeInfo(oldHolder, newHolder, fromX, fromY, toX, toY));
        return true;
    }
        ...
        if (newView != null) {
            ...
            newViewAnimation.setDuration(getChangeDuration())
                ...
                public void onAnimationEnd(View view) {
                    ViewHelper.clear(changeInfo.newHolder);
    ...
    public void endAnimation(RecyclerView.ViewHolder item) {
        ...
        for (int i = mPendingMoves.size() - 1; i >= 0; i--) {
            BaseItemAnimator.MoveInfo moveInfo = mPendingMoves.get(i);
        ...
        for (int i = mChangesList.size() - 1; i >= 0; i--) {
            ArrayList<BaseItemAnimator.ChangeInfo> changes = mChangesList.get(i);
        ...
        for (int i = mMovesList.size() - 1; i >= 0; i--) {
            ArrayList<BaseItemAnimator.MoveInfo> moves = mMovesList.get(i);
            for (int j = moves.size() - 1; j >= 0; j--) {
                BaseItemAnimator.MoveInfo moveInfo = moves.get(j);
                if (moveInfo.holder == item) {
                    view.setTranslationY(0);
                    view.setTranslationX(0);
                    dispatchMoveFinished(item);
    ...
    public void endAnimations() {
        ...
        for (int i = count - 1; i >= 0; i--) {
            BaseItemAnimator.MoveInfo item = mPendingMoves.get(i);
     ...
     * then BaseItemAnimator will call {@link #animateMove(RecyclerView.ViewHolder, int, int, int, int)} and
